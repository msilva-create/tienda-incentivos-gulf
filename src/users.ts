...
export const RAW_USERS: User[] = [
  ...
  { id: 'sv2', name: 'Miguel Vargas', email: 'miguel@servitecas', password: 'GulfSV02', distributor: 'CVC SERVITECAS', gallons: 3541, initialGallons: 1281, balance: 2832800, initialBalance: 0, role: 'COMMERCIAL', monthlyBalances: {} },
