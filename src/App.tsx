...
const App: React.FC = () => {
  ...
  const DEFAULT_REDEEMED: RedeemedItem[] = [
    ...
    { id: 'R-ramos-juandavid-maletin-jun', productId: 'b3', productName: 'Maletín Transportador para Mascota tipo Bolso', price: 170000, date: '2026-06-30T12:00:00Z', userEmail: 'juandavid.ramos', distributor: 'RAMOS DISTRIBUCIONES' },
  ...
  const DEFAULT_RECORDS: MonthlyRecord[] = [
    ...
    // JUNIO - RAMOS DISTRIBUCIONES
    { id: 'default-juancamilo-jun', userId: 'rd6', userName: 'JUAN CAMILO GOMEZ', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 40, valuePerGallon: 0, amountLoaded: 0, redeemed: 0, availableBalance: 0, observations: 'Carga saldo junio - No aplica por mínimo de galones', date: '2026-06-30T12:00:00Z' },
    { id: 'default-edwin-jun', userId: 'rd3', userName: 'EDWIN GAÑÁN', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 26, valuePerGallon: 0, amountLoaded: 0, redeemed: 0, availableBalance: 0, observations: 'Carga saldo junio - No aplica por mínimo de galones', date: '2026-06-30T12:00:00Z' },
    { id: 'default-jorge-jun', userId: 'rd7', userName: 'JORGE MARIN', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 139, valuePerGallon: 600, amountLoaded: 83400, redeemed: 0, availableBalance: 83400, observations: 'Carga saldo junio - Nivel Impulso', date: '2026-06-30T12:00:00Z' },
    { id: 'default-juandavid-jun', userId: 'rd4', userName: 'JUAN DAVID RAMOS', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 950, valuePerGallon: 500, amountLoaded: 475000, redeemed: 0, availableBalance: 475000, observations: 'Carga saldo junio - Tarifa especial autorizada', date: '2026-06-30T12:00:00Z' },
    { id: 'default-mauricio-jun', userId: 'rd5', userName: 'MAURICIO QUICENO', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 145, valuePerGallon: 600, amountLoaded: 87000, redeemed: 0, availableBalance: 87000, observations: 'Carga saldo junio - Nivel Impulso', date: '2026-06-30T12:00:00Z' },
    ...
    { id: 'default-luis-enrique-lagos-jun', userId: '17', userName: 'Luis Enrique', distributor: 'DISTRIBUIDORA LOS LAGOS', month: 'Junio', gallonsSold: 3107, valuePerGallon: 300, amountLoaded: 932100, redeemed: 0, availableBalance: 932100, observations: 'Carga saldo junio', date: '2026-06-30T12:00:00Z' }, 
      // JUNIO - CARGUES CON SALDO
    { id: 'default-mauricio-jun-v2', userId: 'rd5', userName: 'MAURICIO QUICENO', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 190, valuePerGallon: 600, amountLoaded: 114000, redeemed: 0, availableBalance: 114000, observations: 'Nivel Impulso', date: '2026-06-30T12:00:00Z' },
    { id: 'default-alexander-jun-v2', userId: 'rd1', userName: 'ALEXANDER LABRADA', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 704, valuePerGallon: 800, amountLoaded: 563200, redeemed: 0, availableBalance: 563200, observations: 'Nivel Máximo Rendimiento', date: '2026-06-30T12:00:00Z' },
    { id: 'default-santiago-jun-v2', userId: 'rd2', userName: 'SANTIAGO RAMOS', distributor: 'RAMOS DISTRIBUCIONES', month: 'Junio', gallonsSold: 946, valuePerGallon: 800, amountLoaded: 756800, redeemed: 0, availableBalance: 756800, observations: 'Nivel Máximo Rendimiento', date: '2026-06-30T12:00:00Z' },
